...
public class T
{
    ...
    T(XWPFDocument doc) throws XmlException, IOException
    {
        ...
        BigInteger max = new BigInteger("0");	//最大字体
        for (XWPFParagraph para : paras)			//找出最大字体
        {
        ...
        for (XWPFParagraph para : paras)		//在每个para中检测标题
        {
            MP mp = new MP();
            if (para.getCTP().getPPr() != null)
            {
                        ...
                        .getRPr() != null)
                {
                    ...
                    if (lf != null)
                    {
                        if (lf.getEastAsia() != null)
                        {
                            ...
                            if ((lf.getEastAsia().equals("仿宋"))						//三级
